...
| 2026-09-20 | **S5 result:** official mAP@50 **0.2939 vs S1 0.2690** (+0.0249) — best BDD-trained stage, +0.0106 over S2, +0.0198 over S3; 5-fold **0.2951 ± 0.0132 ≈ S2/S3**; in-domain 0.4877. Per weather: **rain 0.244→0.290**, **night 0.193→0.199**, snow 0.284→0.299, **fog 0.491→0.463 (regression)**. Per class: **bus 0.169→0.255**, **truck 0.289→0.321** (above ceiling); recall 0.266→0.301 | Appearance calibration tops the **official** primary metric and captures ~49% of the headroom (best BDD-trained), driven by rain/night and bus/truck; but **5-fold is a tie** and **fog regresses**, so the advantage is official-specific and single-seed. S5 is the natural base for S6a/S6b |
